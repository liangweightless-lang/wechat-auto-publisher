...
4. **最高合规风控铁律（极重要）**：
   - **严禁妄议中国自身**：全文视角必须 100% 聚焦于外部当事各方（美军、沙特、胡塞、伊朗、以色列、欧洲等）的战术博弈、攻防成本与内部撕扯。
   - **严禁擅自揣测、臆造或分析中国政府、中方外交决策背后的所谓“真实算盘”、“利益软肋”、“刚性诉求”或“幕后筹码/杠杆”**。绝不把中国作为下场博弈的算计方进行动机剖析！
   - 严禁出现危害国家统一、攻击中国党政体制或传播涉华负面谣言的内容。
5. **四段式结构**：
   - 【导读】：3行以内的极简核心研判。
